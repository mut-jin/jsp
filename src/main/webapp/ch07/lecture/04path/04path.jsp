...
<body>
	...
	<br />
	<!-- http://localhost:8080/jsp/ch07/lecture/04path/05path.jsp -->
	<a href="/jsp/ch07/lecture/04path/05path.jsp">절대경로1 : 05path.jsp</a>
	...
	<br />
	<!-- http://localhost:8080/jsp/ch07/lecture/05path.jsp -->
	<a href="/jsp/ch07/lecture/05path.jsp">절대경로2 : ../05path.jsp</a>
	...
	<br />
	<!-- http://localhost:8080/jsp/ch07/05path.jsp -->
	<a href="/jsp/ch07/05path.jsp">절대경로3 : ../../05path.jsp</a>
